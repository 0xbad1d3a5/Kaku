...
public class KanjiCharacterView extends TextView implements GestureDetector.OnGestureListener
{
    ...
    {
        //Log.d(TAG, String.format("KanjiCharacterView - onLayout %b, %d, %d, %d, %d", changed, left, top, right, bottom));
    ...
    {
        Log.d(TAG, "KanjiCharacterView - onConfigurationChanged");
